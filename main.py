...
def get_args():
    ...
    parser.add_argument('--md_path', default='./model/resnet50.pth', type=str)
    parser.add_argument('--rot_md_path', default='./model/ssl_rot_checkpoint.pth', type=str)
...
for idx in subset_idx:
    ...
    if test_n % 100 == 0:
        with open(os.path.join(f'./output/s3_supervised/{args.corruption}_{args.guided_type}_{args.skip_timesteps}_result.csv'), 'a') as f: 
            writer = csv.writer(f)
